...
const TableHeader = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead ref={ref} className={cn("bg-secondary/60 [&_tr]:border-b [&_tr]:border-border/50", className)} {...props} />
  )
)
...
const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot ref={ref} className={cn("border-t border-border/50 bg-secondary/40 font-medium [&>tr]:last:border-b-0", className)} {...props} />
  )
)
  ...
  ({ className, ...props }, ref) => (
    <tr
      ...
      className={cn(
        ...
        "hover:bg-primary/4 data-[state=selected]:bg-primary/8",
        className
      )}
      {...props}
    />
